...
export let project = {
  ...
  "graph": {
    ...
    "skipDefault": false,
    "dirs": "/root/testProject/src/flowunit",
    "settingPerfEnable": false,
    "settingPerfTraceEnable": false,
    "settingPerfSessionEnable": false,
    "settingPerfDir": "/tmp/modelbox/perf/",
    "flowunitDebugPath": "/root/testProject/src/flowunit",
    "flowunitReleasePath": "/opt/modelbox/application/testProject"
  },
  "flowunit": {
    "name": "flowunit",
    "desc": "",
    "lang": "python",
    "project-path": "/root/testProject",
    "device": "cpu",
    "port_infos": [],
    "type": "stream",
  ...
  "graphs": [
    {
      "driver": {
        "dir": [
          "/opt/modelbox/application/testProject/flowunit"
        ]
      },
      "flow": {
        "desc": "A hello world REST API service demo.",
